        ...
        <Box className="bg-gray-50 w-[7%] px-4 py-6 flex flex-col items-center shadow-lg gap-4">
            {navItems.map(({ to, label }) => (
                <NavLink
                    ...
                    to={to}
                    className={({ isActive }) =>
                        `flex flex-col items-center text-center w-full p-4 rounded-lg transition-colors duration-200 ${isActive ? "bg-[#85bec3] text-black" : "text-gray-500 hover:bg-gray-100"
                        }`
                    }
                >
